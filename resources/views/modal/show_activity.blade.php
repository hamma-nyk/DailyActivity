<div class="modal fade" id="modalShow{{ $activity->id }}" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea readonly type="text" class="form-control" id="activity" name="activity"
                            placeholder="..." style="min-height: 100px; height: 300px">{{ $activity->activity }}</textarea>
                    </div>
                    @error('activity')
                        <span class="text-red-600">{{ $message }}</span>
                    @enderror
